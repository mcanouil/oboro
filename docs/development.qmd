---
title: "Development"
description: "Build oboro in the devcontainer, run the checks CI runs, and find your way around adding a recogniser or a format."
---

## The devcontainer

Build in the devcontainer.
It carries the pinned Rust toolchain, Tesseract and the OCR libraries, so the only thing your machine needs is Docker, and `cargo build --release --features "ner,ocr"` builds every feature inside it with nothing extra to install.
